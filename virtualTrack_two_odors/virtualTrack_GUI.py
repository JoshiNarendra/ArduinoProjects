...
mouse_label = Tkinter.Label(window, text="Mouse ID:").grid(row=0, column=0) #create a label widget
mouse = Tkinter.Entry(window, width=7)				 .grid(row=0, column=1) #create a text entry widget
#mouse = Tkinter.Entry(window, width=7) #create a text entry widget
mouse.insert(0,"x") #insert default value for the mouse entry

reward_size_label = Tkinter.Label(window, text="Reward size(ms):").grid(row=1, column=0)
reward_size = Tkinter.Entry(window, width=7)					  .grid(row=1, column=1)
#reward_size = Tkinter.Entry(window, width=7)
reward_size.insert(0,"30")

licks_per_reward_label = Tkinter.Label(window, text="Licks/reward:").grid(row=2, column=0)
licks_per_reward = Tkinter.Entry(window, width=7)					.grid(row=2, column=1)
#licks_per_reward = Tkinter.Entry(window, width=7)
licks_per_reward.insert(0,"2")

reward_window_label = Tkinter.Label(window, text="Reward window(s):").grid(row=3, column=0)
reward_window = Tkinter.Entry(window, bg = 'light green', width=7)	 .grid(row=3, column=1)
#reward_window = Tkinter.Entry(window, bg = 'light green', width=7)
reward_window.insert(0,"3")

recording_duration_label = Tkinter.Label(window, text="Recording duration(s):").grid(row=4, column=0)
recording_duration = Tkinter.Entry(window, fg = 'blue', width=7)			   .grid(row=4, column=1)
#recording_duration = Tkinter.Entry(window, fg = 'blue', width=7)
recording_duration.insert(0,"1800")

blank_label = Tkinter.Label(window, width=7).grid(row=5)
#############################################################################

envA_initial_drop_label = Tkinter.Label(window, text="Initial drop(ms):").grid(row=6)
envA_initial_drop = Tkinter.Entry(window, width=5)
envA_initial_drop.insert(0,"30")

envA_max_lap_count_label = Tkinter.Label(window, text="Max laps:").grid(row=7)
envA_max_lap_count = Tkinter.Entry(window, width=5)
envA_max_lap_count.insert(0,"1")

trackA_label = Tkinter.Label(window, text="Track length(mm):").grid(row=8)
trackA = Tkinter.Entry(window, bg = 'light blue', width=7)
trackA.insert(0,"4000")
...
envD_initial_drop_label = Tkinter.Label(window, text="Initial drop(ms):").grid(row=14,column=2)
envD_initial_drop = Tkinter.Entry(window, width=5)
envD_initial_drop.insert(0,"0")

envD_max_lap_count_label = Tkinter.Label(window, text="Max laps:").grid(row=15,column=2)
envD_max_lap_count = Tkinter.Entry(window, width=5)
envD_max_lap_count.insert(0,"0")

envD_odor1_label = Tkinter.Label(window, text="envD_odor1:").grid(row=16,column=2)
envD_odor1 = Tkinter.Entry(window, fg = 'red', width=5)
envD_odor1.insert(0,"0")

envD_odor2_label = Tkinter.Label(window, text="envD_odor2:").grid(row=17,column=2)
envD_odor2 = Tkinter.Entry(window, fg = 'red', width=5)
envD_odor2.insert(0,"0")

envD_odor3_label = Tkinter.Label(window, text="envD_odor3:").grid(row=18,column=2)
